...
import {getTasksThunk,} from "./task-reducer";
...
export const getTodoListThunk = (): AppThunk => (dispatch) => {
...
export const createTodolistThunk = (title: string) => (dispatch: Dispatch<ActionTodolistType>) => {
    dispatch(setAppStatusAC('loading'))
